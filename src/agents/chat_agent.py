...
Standalone Question:"""
        ...
        try:
            ...
            log_exception(logger, "chat_query_contextualization_failed", error, component="chat")
    ...
    def get_response(self, query, vectorstore, chat_history=None):
        ...
        try:
            ...
            log_exception(logger, "chat_context_retrieval_failed", error, component="chat")
            # If retrieval fails, proceed without context
            context = ""

        # 3. Build prompt with context and chat history
        qa_system_prompt = (
            "You are an assistant for health-report follow-up questions. "
        ...
        try:
            ...
            log_exception(logger, "chat_generation_failed", error, component="chat")
            return "Error: The response could not be generated. Please try again."
